...
func (app *application) userSignupPost(w http.ResponseWriter, r *http.Request) {
	...
	form.CheckField(validator.NotBlank(form.Name), "name", validator.InvalidBlankField)

	form.CheckField(validator.NotBlank(form.Email), "email", validator.InvalidBlankField)
	form.CheckField(validator.Matches(form.Email, validator.EmailRX), "email", "This field must be a valid email address")

	form.CheckField(validator.NotBlank(form.Password), "password", validator.InvalidBlankField)
